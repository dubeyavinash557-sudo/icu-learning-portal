...
const demoCourses: DemoCourse[] = [
  {
    ...
    lessons: [
      {
        title:
          "Introduction to ICU Nursing | ICU नर्सिंग परिचय",
        description:
      ...
      {
        title:
          "Vital Signs Monitoring | Vital Signs की Monitoring",
        description:
      ...
      {
        title:
          "Basic ICU Emergency Responsibilities",
        description:
          "Understand the basic nursing responsibilities during an ICU emergency and the importance of immediate assessment and escalation.\n\nइस lesson में ICU emergency के दौरान nurse की basic responsibilities और timely escalation को समझाया जाएगा.",
        duration: 20,
        lessonOrder: 4,
        videoUrl: "",
      },
      ...
      questions: [
        {
          ...
          optionC:
            "Replacing all clinical assessment",
        ...
        },
        {
          ...
          optionB:
            "Immediately assess and escalate appropriately",
    ...
    lessons: [
      {
        ...
        description:
          "Understand why mechanical ventilation is used and the basic purpose of ventilatory support.\n\nइस lesson में mechanical ventilation का basic purpose और ventilatory support की introductory concepts समझाई जाएंगी.",
        duration: 15,
        lessonOrder: 1,
        videoUrl: "",
      },
      {
        title:
          "Basic Ventilator Terms | Important Terminology",
        description:
          "Learn tidal volume, respiratory rate, minute ventilation, FiO₂ and airway pressure.\n\nइस lesson में ventilator के important terms को simple Hindi + English explanation के साथ समझाया जाएगा.",
        duration: 15,
        lessonOrder: 2,
        videoUrl: "",
      },
      {
        ...
        description:
          "Understand the introductory concepts of PEEP and inspired oxygen concentration.\n\nइस lesson में PEEP और FiO₂ के basic concepts और उनका clinical learning context समझाया जाएगा.",
        duration: 15,
        lessonOrder: 3,
        videoUrl: "",
      },
      ...
      questions: [
        {
          ...
          optionB:
            "Pulmonary Emergency Expiratory Pressure",
          optionC:
            "Positive Emergency Exchange Pressure",
          optionD:
            "Pressure End Expiratory Pulse",
          correctAnswer: "A",
          explanation:
        ...
        },
        {
          ...
          optionA:
            "Amount of gas delivered in one breath",
          optionB: "Heart rate",
        ...
        {
          question:
            "A high-pressure alarm may be associated with:",
        ...
        {
          question:
            "When a ventilator alarm sounds, the first priority is:",
          optionA: "Ignore the alarm",
          optionB:
            "Assess the patient and ventilator safely",
          optionC:
...

  {
    ...
    lessons: [
      {
        ...
        description:
          "Understand the purpose of ECG and the basic electrical activity of the heart.\n\nइस lesson में ECG का purpose और heart की basic electrical activity का introduction दिया जाएगा.",
        duration: 15,
        lessonOrder: 1,
        videoUrl: "",
      },
      {
        ...
        description:
          "Learn the basic ECG paper layout, calibration and important measurements.\n\nइस lesson में ECG paper, calibration और basic measurements को समझाया जाएगा.",
        duration: 15,
        lessonOrder: 2,
        videoUrl: "",
      },
      {
        ...
        description:
          "Understand the basic components of a normal ECG.\n\nइस lesson में P wave, QRS complex और T wave के basic concepts समझाए जाएंगे.",
        duration: 15,
        lessonOrder: 3,
        videoUrl: "",
      },
      {
        ...
        description:
          "Learn a simple systematic approach to rate, rhythm and ECG observation.\n\nइस lesson में ECG rate और rhythm को systematically observe करने का introductory approach समझाया जाएगा.",
        duration: 15,
        lessonOrder: 4,
        videoUrl: "",
      },
    ...
    quiz: {
      ...
      questions: [
        ...
        {
          question:
            "Which factor is important during rhythm interpretation?",
          optionA: "Regularity",
          optionB: "Hair colour",
          optionC: "Height",
...
async function upsertDemoCourse(
  ...
  /*
   * IMPORTANT:
   * Do NOT delete lessons here.
   *
   * Existing LessonProgress records point to lesson IDs.
   * Deleting lessons would cascade-delete progress.
   *
   * Instead, update existing lessons by lessonOrder
   * and create only missing lessons.
   */
   ...
   * Quiz safety:
   *
   * Do not delete the existing quiz because QuizAttempts
   * and QuizAttemptAnswers may depend on it.
   */
  ...
  /*
   * Update existing questions in their existing order.
   * Create only missing questions.
   *
   * Existing question IDs are preserved so previous
   * quiz attempt answer relationships remain valid.
   */
  ...
  for (
    let index = 0;
    index < courseData.quiz.questions.length;
    index++
  ) {
    const questionData =
      courseData.quiz.questions[index];
  ...
  console.log(
    `Updated demo course safely: ${course.title}`
  );
}

async function main() {
  console.log(
    "Starting production-safe demo course seeding..."
  );

  for (const courseData of demoCourses) {
    await upsertDemoCourse(courseData);
  }

  console.log(
    "All demo courses were seeded safely."
  );
}
