            ...
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                {isPremium ? (
                  ...
                  <span className="inline-flex items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-300/10 px-4 py-2 text-xs font-black uppercase tracking-[0.14em] text-emerald-300">
              ...
              <h1 className="mt-7 max-w-4xl text-4xl font-black leading-[1.06] tracking-tight text-white sm:text-5xl lg:text-6xl">
                {course?.title || "ICU Emergency & Critical Care Course"}
              </h1>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link
                  href={`/courses/${course?.id ?? COURSE_SLUG}`}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-slate-400">
                          Lessons, assessments, progress tracking and
                          completion features are designed to work
                          together in the LMS.
                        </p>
                      </div>
                    </div>
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-2 divide-x divide-y divide-slate-200 sm:grid-cols-4 sm:divide-y-0">
          <InfoItem
            ...
            label="Instructor"
            value={course?.instructor || "Avinash Dubey"}
          />

          <InfoItem
            icon={<BookOpen size={20} />}
            label="Lessons"
            value={`${lessonCount || 9} structured lessons`}
          />
          ...
          <div className="min-w-0">
            ...
            <section>
              <SectionHeading
                ...
                description="A structured learning pathway covering the core emergency and critical-care concepts healthcare learners need for systematic revision and clinical preparation."
              />

              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {learningOutcomes.slice(0, 6).map((outcome) => (
                  <OutcomeCard key={outcome} text={outcome} />
                ))}
              </div>
            </section>
            ...
            <section id="curriculum" className="mt-16 scroll-mt-24">
              <SectionHeading
                ...
                description="Work through the curriculum progressively. The lesson architecture is prepared for future video, notes, completion and progress tracking."
              />
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-blue-700">
                              <BookOpen size={12} />
                              Module
                            </span>
                          </div>
            ...
            <section className="mt-16">
              <SectionHeading
                ...
                title="Resources Included in the Learning Journey"
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                <ResourceCard
                  icon={<Video size={22} />}
                  title="Video Lessons"
                  description="Structured lesson-based video learning when published."
                />

                <ResourceCard
                  icon={<FileText size={22} />}
                  title="Study Notes"
                  description="Revision-friendly notes and course resources."
                />

                <ResourceCard
                  icon={<CheckCircle2 size={22} />}
                  title="Assessments"
                  description="Knowledge checks and quiz-based practice."
                />
              </div>
            </section>
                ...
                <div className="flex flex-col gap-7 sm:flex-row sm:items-center">
                  ...
                  <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                      Eligible learners who complete the required course
                      and assessment requirements can progress toward a
                      completion certificate with a unique verification
                      number.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-6 text-amber-800">
                    This course is intended for education, revision and
                    professional learning. Clinical decisions should be
                    made according to the patient's condition, local
                    hospital protocols, qualified supervision and
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
              ...
              <div className="p-6">
                <div className="space-y-3">
                  <SidebarFeature
                    icon={<BookOpen size={17} />}
                    text={`${lessonCount || 9} structured lessons`}
                  />

                  <SidebarFeature
                    icon={<Video size={17} />}
                    text="Video learning architecture"
                  />
                ...
                <Link
                  href={`/courses/${course?.id ?? COURSE_SLUG}`}
                  className="group mt-7 flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-700 px-5 py-4 text-sm font-black text-white shadow-lg shadow-blue-700/20 transition duration-300 hover:bg-blue-800 hover:shadow-xl"
                >
                  <PlayCircle size={18} />
                  Start Course
                  <ArrowRight
                ...
                <div className="mt-5 flex items-start gap-2 rounded-xl bg-emerald-50 p-3">
                  ...
                  <p className="text-[11px] font-semibold leading-5 text-emerald-800">
                    Secure learning access and course progress will be
                    handled through the LMS account system.
                  </p>
                </div>
              </div>
            </div>
